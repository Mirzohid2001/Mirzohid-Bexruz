    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fact_ton', models.FloatField(default=0, verbose_name='Fakt ton')),
                ('difference_ton', models.FloatField(default=0, editable=False, verbose_name='Farq (ton)')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Yaratilgan sana')),
                ('batch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='warehouse.batch', verbose_name='Parтия')),
        ...
        migrations.AddField(
            model_name='batch',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='warehouse.product', verbose_name='Mahsulot'),
        ),
        migrations.CreateModel(
            name='Reservoir',
            fields=[
